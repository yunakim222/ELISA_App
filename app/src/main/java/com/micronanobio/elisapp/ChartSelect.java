...
import com.micronanobio.elisapp.R;
...
public class ChartSelect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chartButton.setOnClickListener((v) -> {
            Intent chIntent = new Intent(getApplicationContext(), Chart.class);
        ...
        heatButton.setOnClickListener((v) -> {
            Intent hIntent = new Intent(getApplicationContext(), Heatmap.class);
